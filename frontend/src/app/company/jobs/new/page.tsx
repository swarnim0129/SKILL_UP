...
import { ArrowLeft, Plus, X, Sparkles, Loader2, Check, CircleCheck, ExternalLink } from 'lucide-react';
    ...
    const handleGenerateAI = async () => {
        ...
        try {
            ...
            if (aiPrompt.file) {
                ...
                formData.append('file', aiPrompt.file);
                // If user also typed role/skills, send them too? Usually file overrides or complements.
                // Let's just send the file for parsing.
                response = await api.post('/jobs/generate-ai-file', formData, {
                    headers: {
                ...
                response = await api.post('/jobs/generate-ai',
                    { role: aiPrompt.role, skills: aiPrompt.skills },
    ...
    return (
        <div className="animate-fade-in bg-white dark:bg-black min-h-screen pb-24">
            <div className="flex items-center justify-between mb-8 px-1">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white">Create Job Posting</h2>
                    <p className="text-neutral-500 dark:text-neutral-400">Reach the best talent for your team.</p>
                </div>
